...
public class Lab1 {
    ...
    private static void printArea(Point3d point1, Point3d point2, Point3d point3) {
        ...
        if (point1.equal(point2) || point1.equal(point3) || point2.equal(point3) || (point1.distanceTo(point2) + point1.distanceTo(point3) + point2.distanceTo(point3) - temp) <= temp)
            System.out.println("This points couldn't provide the triangle creation!");
        else
            System.out.println(String.format("The area of triangle created by you'r 3 points is: %.2f", computeArea(point1, point2, point3)));
    }
}